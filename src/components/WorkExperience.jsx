...
/**
 * The WorkExperience component renders a section with a heading and a list
 * of work experiences, with animations applied to each item.
 *
 * @returns {ReactElement} The WorkExperience component.
 */
